...
<body class="bg-gray-100 font-sans">
    <div class="flex">
        ...
        <main class="flex-1 p-6 ml-64">
            ...
            <?php if ($success): ?>
            <div class="bg-green-100 border border-green-300 text-green-800 px-4 py-2 rounded-lg mb-4"><?= $success ?>
            </div>
            <?php elseif ($error): ?>
                    ...
                    <table class="w-full border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="p-3 text-gray-600"><?= htmlspecialchars($cat['slug']) ?></td>
                                <td class="p-3 text-sm text-gray-500"><?= $cat['created_at'] ?></td>
